    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              _buildTab("Customers", true),
              const SizedBox(width: 10),
              _buildTab("Suppliers", false, onTap: () {
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "Add your customer to manage credit and track payments easily.",
            ...
            child: OutlinedButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CustomerFirebaseScreen()));
              },
